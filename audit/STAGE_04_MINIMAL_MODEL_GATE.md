> **Independent-audit amendment (2026-09-20).** The historical phrase that multiplicity is generated by the downstream-exit kink is superseded by `audit/STAGE_04_MECHANISM_INTERPRETATION_AMENDMENT_2026-09-20.md`. The Stage-4 mathematical object is retained; downstream exit generates the positive-slope C7 branch but is not necessary for C8 multiplicity.
